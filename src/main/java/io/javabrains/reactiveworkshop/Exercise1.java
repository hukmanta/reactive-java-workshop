...
public class Exercise1 {
    ...
    public static void main(String[] args) {
        ...
        StreamSources.intNumbersStream().forEach(it -> System.out.print(it + " "));
        System.out.println();
        System.out.println();

        // Print numbers from intNumbersStream that are less than 5
        System.out.println("Print numbers from intNumbersStream that are less than 5");
        StreamSources.intNumbersStream().filter(it -> it < 5).forEach(it -> System.out.print(it + " "));
        System.out.println();
        System.out.println();

        // Print the second and third numbers in intNumbersStream that's greater than 5
        System.out.println("Print the second and third numbers in intNumbersStream that's greater than 5");
        StreamSources.intNumbersStream().filter(it -> it > 5).limit(3).skip(1).forEach(it -> System.out.print(it + " "));
        System.out.println();
        System.out.println();
        ...
        StreamSources.intNumbersStream().filter(it -> it > 5).findFirst().ifPresentOrElse(integer -> System.out.println(integer), () -> System.out.println(-1));
        System.out.println();
